...
/**
 * Scanner source: https://code.tutsplus.com/tutorials/reading-nfc-tags-with-android--mobile-17278
 */
public class RfidScanner extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rfid_scanner_layout);
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                ...
                resultIntent.putExtra(RESULT,result);//Intent mit Daten füllen
